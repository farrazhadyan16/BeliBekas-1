...
<head>
  <title>Daftar alamat - BeliBekas.id</title>
  <meta charset="utf-8">
          ...
          <div class="banner-blocks1">
            ...
            <div class="banner-ad bg-white block-1 mb-4 shadow-sm">
              <div class="row banner-content p-5">
                <div class="content-wrapper col-md-10 d-flex align-items-center justify-content-between"">
                          <div style=" margin-top: 7px;">
                  <h6 class="display-4">Alamat Baru</h6>
                  <p>Untuk membuat pesanan, silahkan tambahkan alamat pengiriman</p>
                  <br>
                </div>
              </div>
              <div class="container mt-4">
                <form action="/submit-form" method="POST">
                  ...
                  <div class="row mb-3">
                    <div class="col-12">
                      <input type="email" class="form-control" id="provinsi" placeholder="Provinsi, Kota, Kecamatan, Kode Pos">
                    </div>
                  </div>

                  <div class="row mb-3">
                    <div class="col-12">
                      <input type="email" class="form-control" id="detail" placeholder="Detail Lainnya">
                    </div>
                  </div>

                  <div class="row mb-3">
                    <div class="col-12">
                      <textarea class="form-control" id="masukan" name="masukan" rows="3" placeholder="Nama Jalan, Gedung, No.Rumah" required></textarea>
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    <div class="col-12">
                      <div style="position: relative; border: 1px solid #ccc; height: 200px;">
                        <img src="images/map.png" alt="Map" style="width: 100%; height: 100%; object-fit: cover;">
                        <button type="button" class="btn btn-light" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); border: 1px solid #ccc;">
                          + Tambahkan Lokasi
                        </button>
                      </div>
                    </div>
                  ...
                  <div class="row mb-3">
                    <div class="col-12">
                      ...
                      <div class="d-flex mt-2">
                        <button type="button" class="btn btn-outline-secondary me-2">Rumah</button>
                        <button type="button" class="btn btn-outline-secondary">Kantor</button>
                      </div>
                      <div class="form-check mt-3">
                        <input class="form-check-input" type="checkbox" id="alamatPribadi">
                        <label class="form-check-label" for="alamatPribadi">Atur sebagai alamat pribadi</label>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-12">
                      <button type="submit" class="btn w-100" onclick="window.location.href='pembayaran.php'" style="background-color: rgb(214, 214, 39); color: white;">Kirim</button>
                    </div>
                  </div>
