...
<body>
  ...
  <section class="py-3" style="background-color: #f0f0f0;">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="banner-blocks1">
            ...
            <div class="banner-ad bg-white block-1 mb-4 shadow-sm">
              <div class="row banner-content p-5">
                <div class="img-wrapper col-md-5">
                  <img src="../assets/images/produk.png" class="img-fluid mb-3" style="border: 1px solid #ccc; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.075);">
                  <img src="../assets/images/produk1.png" class="img-fluid" style="border: 1px solid #ccc; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.075); width: 97px; height: 100px;">
                  <img src="../assets/images/produk2.png" class="img-fluid m-1" style="border: 1px solid #ccc; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.075); width: 97px; height: 100px;">
                  <img src="../assets/images/produk3.png" class="img-fluid m-1" style="border: 1px solid #ccc; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.075); width: 97px; height: 100px;">
                  <img src="../assets/images/produk4.png" class="img-fluid" style="border: 1px solid #ccc; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.075); width: 97px; height: 100px;">
                </div>

                <div class="content-wrapper col-md-7 mt-3">
                  <h6 class="display-4">Sepatu Sevatu</h6>
                  <p class="display-4" style="color: rgb(143, 54, 226);">Rp 30.000</p>
                  <br>

                  <div class="d-flex align-items-center">
                    <h6 class="mb-0 mr-3 ml-3">Ukuran : </h6>
                    <span class="mr-3 ml-3 p-2 border border-3"> 37</span>
                  </div>

                  <div class="d-flex align-items-center">
                    <h6 class="mb-0 mr-3 ml-3">Warna : </h6>
                    <span class="mr-3 ml-3 p-2 border border-3"> Putih</span>
                  </div>

                  <br>

                  <div class="d-flex align-items-center">
                    <h6 class="mb-0 mr-3 ml-3">Deskripsi : </h6>
                  </div>
                  <hr>

                  <p>Sepatu masih dalam kondisi baru dan belum pernah dipakai sama sekali. Dijual karena salah ukuran, jadi kondisinya benar-benar masih seperti baru dari toko. Modelnya simpel dan stylish, cocok untuk gaya kasual sehari-hari atau bahkan untuk tampilan semi-formal</p>

                  <div class="d-flex">
                    <button class="btn" style="background-color: #eff6ff; color: #007bff; margin: 4px;" onclick="window.location.href='nambahkeranjang.php'">
                      <svg width="20" height="20" class="mr-2">
                        <use xlink:href="#cart"></use>
                      </svg>
                      Masukkan Keranjang
                    </button>
                    <button class="btn btn-primary m-1" onclick="window.location.href='pembayaran.php'">Beli Sekarang</button>
                  </div>
            ...
            <div class="banner-ad bg-white block-1 mb-4 shadow-sm">
              <div class="row banner-content p-5">
                <div class="img-wrapper col-md-2">
                  <img src="../assets/images/user2.png" class="img-fluid mb-3">
                </div>

                <div class="content-wrapper col-md-3">
                  <h3>bymee</h3>
                  <p>4.5<img src="../assets/images/star.png" alt="star" style="margin-left: 10px;"></p>
                  <p>Aktif 5 Menit yang lalu</p>
                </div>

                <div class="content-wrapper col-md-7">
                  <div class="d-flex justify-content-between align-items-center">
                    <p>Penilaian <span style="color: rgb(143, 54, 226);">5 </span></p>
                    <p>Persentase Chat Dibalas <span style="color: rgb(143, 54, 226);">95% </span></p>
                    <p>Bergabung <span style="color: rgb(143, 54, 226);">1 Bulan lalu </span></p>
                  </div>

                  <div class="d-flex justify-content-between align-items-center">
                    <p>Produk <span style="color: rgb(143, 54, 226);">8 </span></p>
                    <p>Waktu Chat Dibalas <span style="color: rgb(143, 54, 226);">Hitungan Jam </span></p>
                    <p>Pengikut <span style="color: rgb(143, 54, 226);">4 </span></p>
                  </div>
                </div>
                <div class="d-flex">
                  <button class="btn btn-warning mr-2" style="background-color: #eff6ff; color: #007bff; font-size: 12px; margin-right: 5px;">
                    <img src="../assets/images/chat.png" alt="chat" style="width: 15px; height: 15px; margin-right: 5px;">
                    Chat Sekarang
                  </button>
                  <button class="btn btn-primary" style="background-color: #ffffff; color: #64748b; font-size: 12px;">
                    <img src="../assets/images/toko.png" alt="toko" style="width: 15px; height: 15px; margin-right: 5px;">
                    Beli Sekarang
                  </button>
                </div>
              </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <div class="section-header d-flex justify-content-between">
                        ...
                        <h2 class="section-title">Produk lainnya dari bymee</h2>
