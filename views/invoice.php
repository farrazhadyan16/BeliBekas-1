      ...
      <div class="row">
        <div class="col-md-12">
          <div class="banner-blocks1">
            <div class="banner-ad bg-white block-1 mb-4 shadow-sm p-4">
              <div class="d-flex justify-content-between mb-3">
                <div>
                  <p><strong>Nomor Pesanan:</strong> 15326513651</p>
                  <p><strong>Tanggal Pesanan:</strong> 12 November 2024</p>
                  <br>
                  <p><strong>Nama Pembeli:</strong> Ranny</p>
                  <p><strong>Alamat:</strong> Jln Prof. Dr. Hamka, Air Tawar Padang</p>
                  <p><strong>Metode Pembayaran:</strong> Dana</p>
                </div>
                <div>
                  <img src="../assets/images/logo.svg" alt="BeliBekas.id Logo" style="height: 50px;">
                </div>
              </div>
              <table class="table table-bordered mt-3">
                <thead>
                  <tr style="background-color: #d0e4fc;">
                    <th>No</th>
                    <th>Keterangan</th>
                    <th>Harga</th>
                    <th>Jumlah</th>
              ...
              <div class="text-end mt-3">
                <p><strong>Sub Total:</strong> Rp.60.000</p>
                <p><strong>Diskon:</strong> 0%</p>
                <h4><strong>Total:</strong> Rp.60.000,00</h4>
              </div>
              <div class="text-center mt-4">
                <p><strong>Terima Kasih Sudah Belanja</strong></p>
                <p><small>Barang yang telah dibeli tidak dapat dikembalikan kecuali ada perjanjian</small></p>
              </div>
            </div>
          </div>
        </div>
