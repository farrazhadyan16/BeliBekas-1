...
<body>
  ...
  <section class="py-3" style="background-color: #f9fafb;">
    <div class="container">
      <!-- Header Section -->
      <div class="row">
        <div class="card p-4 mb-4" style="border-radius: 12px; border: 1px solid #e0e0e0; background-color: #ffffff;">
          <div class="col-12">
            <h5>Pengiriman</h5>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          <!-- Shipping Address -->
          <div class="card p-4 mb-4" style="border-radius: 12px; border: 1px solid #e0e0e0; background-color: #ffffff;">
            <h6 style="font-weight: bold; font-size: 16px; margin-bottom: 16px;">Alamat Pengiriman</h6>
            <div class="d-flex justify-content-between align-items-center">
              <div>
                <!-- Icon Maps dan Alamat -->
                <div class="d-flex align-items-center">
                  <img src="../assets/images/maps.png" alt="Maps Icon" style="width: 24px; height: 24px; margin-right: 4px;" />
                  <p style="margin: 0; font-size: 14px;"><span style="color: #007bff; font-weight: bold;">Rumah </span><strong>Ranny</strong></p>
                </div>
                <p style="margin: 0; color: #6c757d;">Jalan Prof. Dr. Hamka, Air Tawar Padang, Sumatera Barat</p>
              </div>
              <button class="btn btn-outline-primary" onclick="window.location.href='daftaralamat.php'" style="border-radius: 8px;">Ganti Alamat</button>
            </div>
          </div>

          <!-- Order 1 -->
          <div class="card p-4 mb-4" style="border-radius: 12px; border: 1px solid #e0e0e0; background-color: #ffffff; width: 100%; max-width: 600px;">
            <!-- Header -->
            <h6 style="font-weight: bold; font-size: 16px; margin-bottom: 16px;">Pesanan 1</h6>
            ...
            <div class="d-flex align-items-center mb-4">
              ...
              <p style="margin: 0; font-size: 14px; font-weight: bold; color: #6c757d;">bymeeee</p>
            </div>
            ...
            <div class="d-flex align-items-start">
              <img
                ...
                alt="Product Image"
                style="width: 80px; height: auto; border-radius: 8px; margin-right: 16px;" />
              <div style="flex-grow: 1;">
                <h6 style="margin: 0; font-size: 14px;">Sepatu Sevatu</h6>
                <p style="margin: 0; font-size: 14px; color: #6c757d;">White, 36</p>
              </div>
              <p style="margin: 0; font-size: 14px; font-weight: bold; margin-left: auto;">Rp 30.000</p>

            </div>
            <button class="btn btn-outline-secondary mt-2" style="border-radius: 8px;" onclick="window.location.href='invoice.php'">Pilih Pengiriman</button>
          </div>
          ...
          <div class="card p-4 mb-4" style="border-radius: 12px; border: 1px solid #e0e0e0; background-color: #ffffff; width: 100%; max-width: 600px;">
            <!-- Header -->
            <h6 style="font-weight: bold; font-size: 16px; margin-bottom: 16px;">Pesanan 2</h6>
            ...
            <button class="btn btn-outline-secondary mt-2" style="border-radius: 8px;">Pilih Pengiriman</button>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="card p-4" style="border-radius: 12px; border: 1px solid #e0e0e0; background-color: #ffffff;">
            ...
            <div class="d-flex justify-content-between align-items-center">
              ...
              <span style="font-weight: bold;">Rp 60.000</span>
            </div>
            <hr>
            <button class="btn btn-outline-primary w-100 mb-3" style="border-radius: 8px; display: flex; justify-content: space-between; align-items: center; background-color: #cfe2ff; color: #ffffff; border: none;">
              ...
              <button class="btn btn-primary w-100" style="border-radius: 8px;" onclick="window.location.href='invoice.php'">Pilih Pembayaran</button>
          </div>
        </div>
      </div>
      <div class="row">
