    ...
    <div class="flex bg-white shadow-lg rounded-lg overflow-hidden">
        <div class="w-1/2 p-8">
            ...
            <form action="../controllers/login_proses.php" method="POST">
                ...
                <div class="mb-4">
                    <label class="block text-gray-700 mb-2" for="ktm">
                        KTM
                    </label>
                    <input
                        class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <p class="mt-4 text-center text-gray-700">
                Don't have an account Seller?
                <a class="text-blue-500 hover:underline" href="register_penjual.php">
                    Register
                </a>
            </p>
            ...
            <p class="mt-4 text-center text-gray-700">
                ...
                <a class="text-blue-500 hover:underline" href="register.php">
                    Register
                </a>
            </p>
        </div>
        <div class="w-1/2 relative">
            <img alt="Wardrobe with clothes" class="object-cover h-full w-full" height="600"
                ...
                width="500" />
            <div class="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-transparent to-white">
            </div>
        </div>
    </div>
</body>
