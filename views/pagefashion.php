...
<head>
  <title>Pakaian - BeliBekas.id</title>
  <meta charset="utf-8">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="banner-blocks1">
            ...
            <div class="swiper main-swiper mb-4" style="border-radius: 12px;">
              <div class="swiper-wrapper">
                <div class="swiper-slide text-center py-5" style="background-color: #f8f9fa;">
                  <h1 style="font-size: 5rem; font-weight: bold; color: #2c2c2c;">Find Your <img src="../assets/images/line.png" alt="Line" style="width: 4rem; color: #feb272;">
                    Style</h1>
                  <h2 style="font-size: 3.5rem; font-weight: bold; color: #2c2c2c;">
                    Preloved
                    <span style="font-size: 1rem; color: #6c757d; width: 20%; display: inline-block; text-align: left;">
                      Pilihan Fashion Ramah Lingkungan untuk Semua Kesempatan
                    </span>Fashion
                  </h2>

                  <div class="d-flex justify-content-center align-items-center my-4">
                    <div style="position: relative;">
                      <img src="../assets/images/fashion.png" alt="Fashion" style="height: 400px; z-index: 2; position: relative;">
                    </div>
                  </div>
                  <!-- Search bar section -->
                  <div class="d-flex justify-content-center align-items-center my-4">
                    <div style="position: relative; display: flex; max-width: 600px; width: 100%; border-radius: 50px;">
                      <input type="text" class="form-control" placeholder="Temukan fashion preloved terbaikmu" style="border-radius: 50px 0 0 50px; padding-left: 40px; background-image: url('../assets/images/search.png'); background-position: 10px center; background-repeat: no-repeat; background-size: 20px 20px;">
                      <button class="btn btn-primary" style="background-color: #6ea8fe; border: none; padding: 10px 20px; margin-left: 10px;">
                        Cari
                      </button>
                      ...
                      <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                          ...
                          <div class="product-item">
                            <figure>
                              <a href="index.html" title="Product Title">
                                <img src="../assets/images/fashion1.png" class="tab-image">
                              </a>
                            </figure>
                            <hr style="border-color: #93c5fd; border-width: 3px;">
                            <h3>Kaos Pria</h3>
                            <span class="price" style="color: #1d4ed8; font-size:15px">Rp 50.000</span>
                          </div>
                        </div>
                        ...
                        <div class="col">
                          <div class="product-item">
                            <figure>
                              <a href="index.html" title="Product Title">
                                <img src="../assets/images/fashion2.png" class="tab-image">
                              </a>
                            </figure>
                            <hr style="border-color: #93c5fd; border-width: 3px;">
                            <h3>Sepatu Sevatu</h3>
                            <span class="price" style="color: #1d4ed8; font-size:15px">Rp 30.000</span>
                          </div>
                        </div>
                        ...
                        <div class="col">
                          <div class="product-item">
                            <figure>
                              <a href="index.html" title="Product Title">
                                <img src="../assets/images/fashion3.png" class="tab-image">
                              </a>
                            </figure>
                            <hr style="border-color: #93c5fd; border-width: 3px;">
                            <h3>3 pcs pashmina dubai</h3>
                            <span class="price" style="color: #1d4ed8; font-size:15px">Rp 65.000</span>
                          </div>
                        </div>
                        ...
                        <div class="col">
                          <div class="product-item">
                            <figure>
                              <a href="index.html" title="Product Title">
                                <img src="../assets/images/fashion4.png" class="tab-image">
                              </a>
                            </figure>
                            <hr style="border-color: #93c5fd; border-width: 3px;">
                            <h3>Croptop</h3>
                            <span class="price" style="color: #1d4ed8; font-size:15px">Rp 20.000</span>
                          </div>
                        </div>
                        ...
                        <div class="col">
                          <div class="product-item">
                            <figure>
                              <a href="index.html" title="Product Title">
                                <img src="../assets/images/fashion5.png" class="tab-image">
                              </a>
                            </figure>
                            <hr style="border-color: #93c5fd; border-width: 3px;">
                            <h3>Docmart</h3>
                            <span class="price" style="color: #1d4ed8; font-size:15px">Rp 45.000</span>
                          </div>
                        </div>
                        ...
                        <div class="col">
                          <div class="product-item">
                            <figure>
                              <a href="index.html" title="Product Title">
                                <img src="../assets/images/fashion6.png" class="tab-image">
                              </a>
                            </figure>
                            <hr style="border-color: #93c5fd; border-width: 3px;">
                            <h3>Sepatu Adorable</h3>
                            <span class="price" style="color: #1d4ed8; font-size:15px">Rp 105.000</span>
                          </div>
                        </div>
                        ...
                        <div class="col">
                          <div class="product-item">
                            <figure>
                              <a href="index.html" title="Product Title">
                                <img src="../assets/images/fashion7.png" class="tab-image">
                              </a>
                            </figure>
                            <hr style="border-color: #93c5fd; border-width: 3px;">
                            <h3>Manset viral tiara andini</h3>
                            <span class="price" style="color: #1d4ed8; font-size:15px">Rp 20.000</span>
                          </div>
                        </div>
                        ...
                        <div class="col">
                          <div class="product-item">
                            <figure>
                              <a href="index.html" title="Product Title">
                                <img src="../assets/images/fashion8.png" class="tab-image">
                              </a>
                            </figure>
                            <hr style="border-color: #93c5fd; border-width: 3px;">
                            <h3>Flatshoes</h3>
                            <span class="price" style="color: #1d4ed8; font-size:15px">Rp 34.000</span>
                          </div>
                        </div>
                        ...
                        <div class="col">
                          <div class="product-item">
                            <figure>
                              <a href="index.html" title="Product Title">
                                <img src="../assets/images/fashion9.png" class="tab-image">
                              </a>
                            </figure>
                            <hr style="border-color: #93c5fd; border-width: 3px;">
                            <h3>Sepatu Heels</h3>
                            <span class="price" style="color: #1d4ed8; font-size:15px">Rp 80.000</span>
                          </div>
                        </div>
                        ...
                        <div class="col">
                          <div class="product-item">
                            <figure>
                              <a href="index.html" title="Product Title">
                                <img src="../assets/images/fashion10.png" class="tab-image">
                              </a>
                            </figure>
                            <hr style="border-color: #93c5fd; border-width: 3px;">
                        ...
                        <div class="col">
                          <div class="product-item">
                            <figure>
                              <a href="index.html" title="Product Title">
                                <img src="../assets/images/fashion11.png" class="tab-image">
                              </a>
                            </figure>
                            <hr style="border-color: #93c5fd; border-width: 3px;">
                            <h3>Hijab Paris Jadul</h3>
                            <span class="price" style="color: #1d4ed8; font-size:15px">Rp 10.000</span>
                          </div>
                        </div>
                        ...
                        <div class="col">
                          <div class="product-item">
                            <figure>
                              <a href="index.html" title="Product Title">
                                <img src="../assets/images/fashion12.png" class="tab-image">
                              </a>
                            </figure>
                            <hr style="border-color: #93c5fd; border-width: 3px;">
                            <h3>Kemeja Uniqlo</h3>
                        ...
                        <div class="col">
                          <div class="product-item">
                            <figure>
                              <a href="index.html" title="Product Title">
                                <img src="../assets/images/fashion13.png" class="tab-image">
                              </a>
                            </figure>
                            <hr style="border-color: #93c5fd; border-width: 3px;">
                            <h3>Hoodie Gemass</h3>
                        ...
                        <div class="col">
                          <div class="product-item">
                            <figure>
                              <a href="index.html" title="Product Title">
                                <img src="../assets/images/fashion14.png" class="tab-image">
                              </a>
                            </figure>
                            <hr style="border-color: #93c5fd; border-width: 3px;">
                            <h3>Cardigan Tebal</h3>
                            <span class="price" style="color: #1d4ed8; font-size:15px">Rp 60.000</span>
                          </div>
                        </div>
                        ...
                        <div class="col">
                          <div class="product-item">
                            <figure>
                              <a href="index.html" title="Product Title">
                                <img src="../assets/images/fashion15.png" class="tab-image">
                              </a>
                            </figure>
                            <hr style="border-color: #93c5fd; border-width: 3px;">
                            <h3>Hijab Motif</h3>
                        ...
                        <div class="col">
                          <div class="product-item">
                            <figure>
                              <a href="index.html" title="Product Title">
                                <img src="../assets/images/fashion16.png" class="tab-image">
                              </a>
                            </figure>
                            <hr style="border-color: #93c5fd; border-width: 3px;">
                            <h3>Sepatu Adidas Samba</h3>
                            <span class="price" style="color: #1d4ed8; font-size:15px">Rp 200.000</span>
                          </div>
                        </div>
