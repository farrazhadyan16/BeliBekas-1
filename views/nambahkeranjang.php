            ...
            <div class="banner-ad bg-white block-1 mb-4 shadow-sm">
              <div class="row banner-content p-5">
                <div class="img-wrapper col-md-2">
                  <img src="../assets/images/produk.png" class="img-fluid" style="border: 1px solid #ccc; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.075); width: 97px; height: 100px;">
                </div>
                ...
                <button class="btn btn-primary m-1" onclick="window.location.href='keranjang.php'">Lihat Keranjang</button>
              </div>
            </div>
          </div>
