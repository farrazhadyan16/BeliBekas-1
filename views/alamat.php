      ...
      <div class="row py-3 border-bottom">
        ...
        <div class="col-sm-8 col-lg-4 justify-content-end gap-5 align-items-center mt-4 mt-sm-3 justify-content-center justify-content-sm-end">
          <ul class="d-flex justify-content-end list-unstyled m-0">
            ...
            <li>
              <a href="#" class="rounded-circle bg-light p-2 mx-1">
                <img src="images/bell.png" alt="bell" class="img-fluid" width="24" height="24"> </a>
            </li>
            <li>
              <a href="#" class="rounded-circle bg-light p-2 mx-1">
                <img src="images/chat.png" alt="chat" class="img-fluid" width="24" height="24">
              </a>
            </li>
            <li>
              <a href="#" class="rounded-circle bg-light p-2 mx-1 text-decoration-none">
                <img src="images/user.png" alt="User Avatar" class="rounded-circle" width="24" height="24">
                <span class="ms-2 text-dark">Nama User</span>
              </a>
          ...
          <div class="banner-blocks1">
            <div class="banner-ad bg-white block-1 mb-4 shadow-sm">
              <div class="row banner-content p-5">
                <div class="col-12">
                  <div style="font-size: 14px; color: #007bff; margin-bottom: 10px;">
                    <img src="images/maps.png" alt="Maps Icon" style="width: 16px; height: 16px; margin-right: 5px;">
                    Alamat Pengiriman
                  </div>
                  <div style="display: flex; justify-content: space-between; align-items: flex-start; font-size: 14px; margin-bottom: 10px;">
                    <div>
                    ...
                    <div style="color: #555; max-width: 60%; text-align: left;">
                      Jl. Prof. Dr. Hamka No.1, Air Tawar Bar., Kec. Padang Utara, Kota Padang, Sumatera Barat 25173
                    </div>
                    <div style="display: flex; align-items: center;">
                      <button class="btn btn-outline-primary btn-sm" style="margin-right: 10px;">Utama</button>
                      <button class="btn btn-link btn-sm text-decoration-none" style="color: #3d8bfd;">Ubah</button>
                    </div>
                  </div>
                </div>
                <hr>
                <div class="form-check">
                  <input class="form-check-input" type="checkbox" id="dropshipper">
