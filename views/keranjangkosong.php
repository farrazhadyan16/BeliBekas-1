          ...
          <div class="card p-4" style="border-radius: 12px; border: 1px solid #e0e0e0; background-color: #ffffff;">
            <div class="d-flex align-items-center">
              <div style="flex-shrink: 0;">
                <img src="../assets/images/cart.png" alt="Shopping Cart Illustration" />
              </div>
              <div class="ms-4">
                <h6 style="font-weight: bold; font-size: 18px; margin-bottom: 8px;">Keranjangmu masih kosong</h6>
                <p style="color: #6c757d; font-size: 14px; margin-bottom: 16px;">
                  Jangan biarkan barang pre-loved impianmu diambil orang lain. Cek koleksi kami sekarang.
                </p>
                <button class="btn btn-primary" style="border-radius: 8px;" onclick="window.location.href='keranjang.php'">Mulai Belanja</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="card p-4" style="border-radius: 12px; border: 1px solid #e0e0e0; background-color: #ffffff;">
            ...
            <button
              ...
              style="border-radius: 8px; background-color: #3d8bfd; border: none;">
              Beli
            </button>
          </div>
        </div>
